...
async function main() {
  await prisma.$transaction([
    prisma.$executeRaw`INSERT INTO status_type (status_type_id, code) VALUES (1, 'available') ON CONFLICT (status_type_id) DO NOTHING`,
    prisma.$executeRaw`INSERT INTO status_type (status_type_id, code) VALUES (2, 'in game') ON CONFLICT (status_type_id) DO NOTHING`,
    ...
    prisma.$executeRaw`INSERT INTO room_player_type (room_player_type_id, code) VALUES (2, 'player') ON CONFLICT (room_player_type_id) DO NOTHING`,
